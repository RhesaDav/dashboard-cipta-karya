    ...
    <div className="p-4 md:p-6 space-y-6 max-w-screen-2xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
          <Input onChange={handleSearch} placeholder="Cari pegawai..." />
          <Button
            variant="outline"
      ...
      <DataTable
        ...
        isLoading={false}
        totalItems={0}
        noDataMessage="Tidak ada data pegawai tersedia"
        noFilteredDataMessage="Tidak ada pegawai yang sesuai dengan filter"
